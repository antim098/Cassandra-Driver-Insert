...
//            new ThreadPoolExecutor(1, 1, 30, TimeUnit.SECONDS, new LinkedBlockingDeque<>());
    ...
    static {
        ...
        poolingOptions.setConnectionsPerHost(HostDistance.LOCAL, 5, 15) //Default core=max=1 in Protocol v3
                .setMaxRequestsPerConnection(HostDistance.LOCAL, 15360) //Default 1024 in Protocol v3
                .setMaxRequestsPerConnection(HostDistance.REMOTE, 256); //Default 256 in Protocol v3
